        ...
        while(progress)
        {
            ...
            while(test_iterator.hasNext())
            {
                ...
                if(ready(test_class, successful_tests))
                {
                    ...
                    if(stream != null)
                    {
                        stream.println(notice(test_class) + "..."); /* PT 1/8 add "ln" */
                        stream.flush();
                    }
                    ...
                    if(result.successful())
                    {
                        ...
                        if(stream != null)
                        {
                            stream.println(test_class.getSimpleName() + " PASSED"); /* PT 1/8 change " ok" to simple class name */
                            stream.flush();
                        }
                    ...
                    if(stream != null)
                    {
                        stream.println(test_class.getSimpleName() + " FAILED"); /* PT 1/8 change " failed" to simple class name */
                        stream.flush();
                    }
